...
export const addcustomer = (n, resetForm) => {
  return (dispatch) => {
    axios
      .post('https://dct-billing-app.herokuapp.com/api/customers', n, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('pos_token')}`,
        },
      })
...
export const addProduct = (n, resetForm) => {
  return (dispatch) => {
    axios
      .post('https://dct-billing-app.herokuapp.com/api/products', n, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('pos_token')}`,
        },
      })
...
export const addBill = (n, setAddProduct, posted) => {
  return (dispatch) => {
    axios
      .post('https://dct-billing-app.herokuapp.com/api/bills', n, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('pos_token')}`,
        },
      })
