...
function DashBoard(props) {
  ...
  const monthlyData = useCallback((value) => {
  ...
  }, [bills, history, monthlyData, option]);
    ...
    <div className="dashboard">
      ...
      <div className="cardContainer">
        <Card
          ...
          extra={<Link to="/main/customers">View</Link>}
          className="cards"
        >
        ...
        <Card
          ...
          extra={<Link to="/main/products">View</Link>}
          className="cards"
        >
        ...
        <Card
          ...
          extra={<Link to="/main/bills">View</Link>}
          className="cards"
        >
        ...
        <Card className="cards" style={{ width: "65%" }}>
          <Select
            defaultValue={option}
            style={{ width: 120, margin: "5px 5px" }}
          ...
          >
            ...
            {graphData.map((ele) => {
              return (
                <Select.Option key={ele.monthId} value={ele.monthId}>
                  {ele.label}
                </Select.Option>
              );
            })}
          ...
          >
            <Card>
              <Statistic
                ...
                valueStyle={{
                  color:
                    yestTotalAmount() > TodayTotalAmount() ? "#3f8600" : "red",
                }}
                prefix={
                  yestTotalAmount() > TodayTotalAmount() ? (
                    <ArrowUpOutlined />
                  ) : (
                    <ArrowDownOutlined />
                  )
            ...
            <Card>
              <Statistic
                ...
                valueStyle={{
                  color:
                    TodayTotalAmount() > yestTotalAmount() ? "#3f8600" : "red",
                }}
                prefix={
                  TodayTotalAmount() > yestTotalAmount() ? (
                    <ArrowUpOutlined />
                  ) : (
                    <ArrowDownOutlined />
                  )
