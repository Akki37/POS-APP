...
function BillModal(props) {
  ...
  const tableData = useMemo(() => getData(data, products), [data, products]);
      ...
      <div id='modalBox'>
        ...
        >
          ...
          <div className='billTo'>
            ...
            <em style={styleEm}>
              {' '}
              {findCust(bill.customer, 'name')} <Breadcrumb.Separator /> mob :
              {findCust(bill.customer, 'mobile')}
            </em>
          </div>
        </div>
        <Table
